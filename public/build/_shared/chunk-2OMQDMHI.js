...
function truncateText(text, charLimit = 30, withEllipsis = true) {
...
function createSlug(text) {
  if (!text)
    return "";
  return (0, import_slugify.default)(text, { lower: true, strict: true });
}
function pluralizeWord(word, count) {
  return (0, import_pluralize.default)(word, count, true);
}
function stringifyCode(code) {
  return JSON.stringify(code, null, 2);
}
function getNameInitials(name = "First Last") {
...
//# sourceMappingURL=/build/_shared/chunk-2OMQDMHI.js.map
