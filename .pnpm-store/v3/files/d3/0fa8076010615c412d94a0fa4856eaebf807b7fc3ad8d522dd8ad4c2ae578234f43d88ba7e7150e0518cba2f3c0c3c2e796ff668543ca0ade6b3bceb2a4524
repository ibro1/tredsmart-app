...
const SiMicrosoftpowerpoint = React.forwardRef(function SiMicrosoftpowerpoint2({ title = "Microsoft PowerPoint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
