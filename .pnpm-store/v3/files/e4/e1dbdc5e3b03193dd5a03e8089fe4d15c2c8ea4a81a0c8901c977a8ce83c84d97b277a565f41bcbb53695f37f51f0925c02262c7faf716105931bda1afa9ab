    ...
    type SiIbmProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#052FAD';

    const SiIbm: IconType = React.forwardRef<SVGSVGElement, SiIbmProps>(function SiIbm({title = 'IBM', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiIbm as default, defaultColor };
