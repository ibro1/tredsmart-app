...
const defaultColor = "#0C54C2";
const SiXaml = React__namespace.forwardRef(function SiXaml2({ title = "XAML", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
