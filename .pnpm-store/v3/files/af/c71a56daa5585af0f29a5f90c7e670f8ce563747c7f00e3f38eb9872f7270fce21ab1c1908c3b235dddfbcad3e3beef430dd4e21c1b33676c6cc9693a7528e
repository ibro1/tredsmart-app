    ...
    type SiGooglebardProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#886FBF';

    const SiGooglebard: IconType = React.forwardRef<SVGSVGElement, SiGooglebardProps>(function SiGooglebard({title = 'Google Bard', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGooglebard as default, defaultColor };
