...
const SiPowerfx = React__namespace.forwardRef(function SiPowerfx2({ title = "Power Fx", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
