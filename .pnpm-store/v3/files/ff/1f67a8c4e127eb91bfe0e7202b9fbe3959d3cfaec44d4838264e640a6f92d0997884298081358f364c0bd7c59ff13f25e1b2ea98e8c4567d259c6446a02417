...
const defaultColor = "#8D73B0";
const SiFluxus = React.forwardRef(function SiFluxus2({ title = "Fluxus", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
