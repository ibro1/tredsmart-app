...
const SiMicrosoftonedrive = React__namespace.forwardRef(function SiMicrosoftonedrive2({ title = "Microsoft OneDrive", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
