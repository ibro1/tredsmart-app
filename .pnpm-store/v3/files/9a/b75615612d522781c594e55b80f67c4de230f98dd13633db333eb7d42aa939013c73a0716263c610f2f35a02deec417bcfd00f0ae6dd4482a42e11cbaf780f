...
const SiMicrosoftexchange = React__namespace.forwardRef(function SiMicrosoftexchange2({ title = "Microsoft Exchange", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
