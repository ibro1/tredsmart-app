    ...
    type SiDataverseProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiDataverse: IconType = React.forwardRef<SVGSVGElement, SiDataverseProps>(function SiDataverse({title = 'Dataverse', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
