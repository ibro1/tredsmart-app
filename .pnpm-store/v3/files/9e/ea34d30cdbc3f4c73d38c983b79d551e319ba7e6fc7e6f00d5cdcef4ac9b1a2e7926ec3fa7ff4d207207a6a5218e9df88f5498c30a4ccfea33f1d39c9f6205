    ...
    type SiAzuredataexplorerProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiAzuredataexplorer: IconType = React.forwardRef<SVGSVGElement, SiAzuredataexplorerProps>(function SiAzuredataexplorer({title = 'Azure Data Explorer', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
