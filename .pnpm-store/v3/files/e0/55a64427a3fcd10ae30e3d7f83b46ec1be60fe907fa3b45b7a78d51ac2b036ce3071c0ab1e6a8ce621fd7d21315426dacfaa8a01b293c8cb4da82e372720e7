...
const SiPowerapps = React__namespace.forwardRef(function SiPowerapps2({ title = "Power Apps", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
