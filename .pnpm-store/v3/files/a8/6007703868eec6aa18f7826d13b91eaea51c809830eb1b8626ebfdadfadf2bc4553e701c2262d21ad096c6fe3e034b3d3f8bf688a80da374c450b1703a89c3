    ...
    type SiHuluProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiHulu: IconType = React.forwardRef<SVGSVGElement, SiHuluProps>(function SiHulu({title = 'Hulu', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
