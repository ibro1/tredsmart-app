...
const SiDynamics365 = React.forwardRef(function SiDynamics3652({ title = "Dynamics 365", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
