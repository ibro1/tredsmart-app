    ...
    type SiNintendonetworkProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#FF7D00';

    const SiNintendonetwork: IconType = React.forwardRef<SVGSVGElement, SiNintendonetworkProps>(function SiNintendonetwork({title = 'Nintendo Network', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiNintendonetwork as default, defaultColor };
