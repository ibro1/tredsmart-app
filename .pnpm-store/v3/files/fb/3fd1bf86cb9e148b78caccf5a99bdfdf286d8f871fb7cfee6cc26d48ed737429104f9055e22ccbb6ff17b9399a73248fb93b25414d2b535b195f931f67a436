...
const SiInfiniti = React__namespace.forwardRef(function SiInfiniti2({ title = "Infiniti", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
