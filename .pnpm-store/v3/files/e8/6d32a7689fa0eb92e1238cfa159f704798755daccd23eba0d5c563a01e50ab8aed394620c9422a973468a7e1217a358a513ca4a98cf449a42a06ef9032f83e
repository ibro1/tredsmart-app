...
const defaultColor = "#528DD7";
const SiFontawesome = React.forwardRef(function SiFontawesome2({ title = "Font Awesome", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
