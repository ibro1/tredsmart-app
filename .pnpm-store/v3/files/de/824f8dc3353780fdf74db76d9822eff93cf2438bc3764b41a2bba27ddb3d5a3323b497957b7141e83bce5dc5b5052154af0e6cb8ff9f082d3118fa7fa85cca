    ...
    type SiEProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiE: IconType = React.forwardRef<SVGSVGElement, SiEProps>(function SiE({title = '/e/', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
