    ...
    type SiDynamics365Props = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#0B53CE';

    const SiDynamics365: IconType = React.forwardRef<SVGSVGElement, SiDynamics365Props>(function SiDynamics365({title = 'Dynamics 365', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiDynamics365 as default, defaultColor };
