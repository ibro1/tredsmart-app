...
const defaultColor = "#106EBE";
const SiYammer = React__namespace.forwardRef(function SiYammer2({ title = "Yammer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
