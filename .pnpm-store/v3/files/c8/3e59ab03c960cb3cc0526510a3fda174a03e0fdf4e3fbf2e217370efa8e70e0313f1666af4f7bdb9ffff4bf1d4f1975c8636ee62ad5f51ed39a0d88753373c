    ...
    type SiMicrosoftsharepointProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftsharepoint: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftsharepointProps>(function SiMicrosoftsharepoint({title = 'Microsoft SharePoint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicrosoftsharepoint as default, defaultColor };
