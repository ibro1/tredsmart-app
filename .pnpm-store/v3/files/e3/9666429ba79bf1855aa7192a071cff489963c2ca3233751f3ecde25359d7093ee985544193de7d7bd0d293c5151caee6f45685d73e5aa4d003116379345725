    ...
    type SiGoogledomainsProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiGoogledomains: IconType = React.forwardRef<SVGSVGElement, SiGoogledomainsProps>(function SiGoogledomains({title = 'Google Domains', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiGoogledomains as default, defaultColor };
