...
const defaultColor = "#CA0404";
const SiFite = React.forwardRef(function SiFite2({ title = "FITE", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
