    ...
    type SiMicrosoftpowerpointProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftpowerpoint: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftpowerpointProps>(function SiMicrosoftpowerpoint({title = 'Microsoft PowerPoint', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicrosoftpowerpoint as default, defaultColor };
