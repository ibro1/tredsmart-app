    ...
    type SiTencentqqProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const defaultColor = '#EB1923';

    const SiTencentqq: IconType = React.forwardRef<SVGSVGElement, SiTencentqqProps>(function SiTencentqq({title = 'Tencent QQ', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiTencentqq as default, defaultColor };
