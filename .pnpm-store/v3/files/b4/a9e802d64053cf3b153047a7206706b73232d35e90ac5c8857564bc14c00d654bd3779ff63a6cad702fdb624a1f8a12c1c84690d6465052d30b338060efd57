...
const defaultColor = "#0076D6";
const SiInternetexplorer = React__namespace.forwardRef(function SiInternetexplorer2({ title = "Internet Explorer", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
