...
const defaultColor = "#3955A3";
const SiMicrosoftvisio = React__namespace.forwardRef(function SiMicrosoftvisio2({ title = "Microsoft Visio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
