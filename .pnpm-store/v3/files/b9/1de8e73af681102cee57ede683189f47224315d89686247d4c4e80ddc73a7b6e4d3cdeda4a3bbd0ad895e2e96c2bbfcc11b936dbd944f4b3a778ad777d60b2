    ...
    type SiMicrosoftacademicProps = React.ComponentPropsWithoutRef<'svg'> & {
      /**
    ...
    const SiMicrosoftacademic: IconType = React.forwardRef<SVGSVGElement, SiMicrosoftacademicProps>(function SiMicrosoftacademic({title = 'Microsoft Academic', color = 'currentColor', size = 24, ...others }, ref) {
      if (color === 'default') {
        color = defaultColor;
      }
    ...
    export { SiMicrosoftacademic as default, defaultColor };
