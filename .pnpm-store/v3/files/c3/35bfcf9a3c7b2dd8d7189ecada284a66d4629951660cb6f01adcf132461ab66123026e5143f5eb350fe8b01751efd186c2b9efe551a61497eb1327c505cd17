...
const SiVisualstudio = React.forwardRef(function SiVisualstudio2({ title = "Visual Studio", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
