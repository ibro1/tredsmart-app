...
const defaultColor = "#B366F6";
const SiGoogleoptimize = React.forwardRef(function SiGoogleoptimize2({ title = "Google Optimize", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
