...
const SiXamarin = React.forwardRef(function SiXamarin2({ title = "Xamarin", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
