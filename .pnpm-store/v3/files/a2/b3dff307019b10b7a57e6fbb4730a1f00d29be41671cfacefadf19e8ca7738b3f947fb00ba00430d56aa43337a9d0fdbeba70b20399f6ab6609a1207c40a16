...
const SiFlattr = React.forwardRef(function SiFlattr2({ title = "Flattr", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
