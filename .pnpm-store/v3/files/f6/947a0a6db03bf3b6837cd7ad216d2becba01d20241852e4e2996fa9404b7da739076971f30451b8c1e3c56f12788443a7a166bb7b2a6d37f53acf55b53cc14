...
const defaultColor = "#B7472A";
const SiMicrosoftpowerpoint = React__namespace.forwardRef(function SiMicrosoftpowerpoint2({ title = "Microsoft PowerPoint", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
