...
const SiPlaywright = React__namespace.forwardRef(function SiPlaywright2({ title = "Playwright", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
