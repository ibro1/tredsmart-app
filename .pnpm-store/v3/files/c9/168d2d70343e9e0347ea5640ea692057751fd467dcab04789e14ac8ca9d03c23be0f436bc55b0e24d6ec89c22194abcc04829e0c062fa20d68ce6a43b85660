...
const defaultColor = "#62B47A";
const SiMinecraft = React__namespace.forwardRef(function SiMinecraft2({ title = "Minecraft", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
